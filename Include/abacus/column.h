 ...
 */
      ABA_COLUMN(ABA_GLOBAL *glob, ABA_MESSAGE &msg);

/*! Packs the data of the column in an ABA_MESSAGE object.
 *
 *\param msg The ABA_MESSAGE object in which the column is packed.
 */
