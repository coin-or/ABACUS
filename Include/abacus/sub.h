 ...
 *
 * $Id: sub.h,v 2.5 2007/07/23 16:00:08 baumann Exp $
 */
 ...
 *   creates the subproblem from an ABA_MESSAGE.
 *
 ...
 *
 *   \param msg The ABA_MESSAGE object from which the subproblem is initialized.
 */
      ABA_SUB(ABA_MASTER *master, ABA_MESSAGE &msg);

/*! Packs the data of the subproblem in an ABA_MESSAGE object.
 *
 ...
 *
 *   \param msg The ABA_MESSAGE object in which the subproblem is packed.
 */
...
#ifdef ABACUS_PARALLEL
inline int ABA_SUB::fatherId() const
  {
    return fatherId_;
  }
#endif
