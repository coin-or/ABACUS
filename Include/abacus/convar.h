 ...
 * the subproblem. The \a sub_ pointer of the constraint/variable is then set
 * to this subproblem.
 *
 *     \param master A pointer to the corresponding master of the optimization.
 *     \param msg The message from which the object is initialized.
 */
    ABA_CONVAR (ABA_MASTER *master, ABA_MESSAGE &msg);

/*! Packs the data of the constraint/variable in an ABA_MESSAGE object. 
 *
 ...
 *
 *   \param msg The ABA_MESSAGE object in which the constraint/variable
 *                  is packed.
 */
