 ...
 *    creates the row from an ABA_MESSAGE.
 *
 *     \param
 ...
 */
      ABA_ROW(ABA_GLOBAL *glob, ABA_MESSAGE &msg);

/*! \brief The function \a pack()
 *   packs the data of the row in an ABA_MESSAGE object.
 *
 *   \param msg The ABA_MESSAGE object in which the row is packed.
 */
