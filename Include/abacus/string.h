 ...
 *   \param index The integer value appending to the \a cString (must
 ...
 *   creates the ABA_STRING from an ABA_MESSAGE.
 *
 *   \param msg The ABA_MESSAGE object from which the string is initialized.
 */
      ABA_STRING(ABA_GLOBAL *glob, ABA_MESSAGE &msg);

/*! Unpacks the string from an ABA_MESSAGE object.
 *
 *   \param msg The ABA_MESSAGE object from which the string is unpacked.
 */
      void unpack(ABA_MESSAGE &msg);

/*! Packs the string in an ABA_MESSAGE object.
 *
 *   \param msg The ABA_MESSAGE object in which the string is packed.
 */
...
/*! \return The length of the string, not including the {\tt '\f$\backslash\f$0'} 
 ...
 *   with {\tt '\f$\backslash\f$0'} to an integer. 
