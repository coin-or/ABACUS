 ...
 */
      ABA_ARRAY(const ABA_GLOBAL *glob, ABA_MESSAGE &msg);

/*! Packs all elements of the array in an ABA_MESSAGE object.
 *
 * \param msg The ABA_MESSAGE object in which the array is packed.
 */
      void pack(ABA_MESSAGE &msg) const;

/*! \brief This version of the function \a pack()
 *  packs a limited number of elements of the
 *  array in an ABA_MESSAGE object, only.
 *
 * \param msg The ABA_MESSAGE object in which the array is packed.
 * \param nPacked The number of elements to be packed.
 */
      void pack(ABA_MESSAGE &msg, int nPacked) const;
#endif
