...
#if !(defined ABACUS_COMPILER_GCC34 || defined ABACUS_COMPILER_GCC41 || \
      defined ABACUS_COMPILER_GCC33 || defined ABACUS_COMPILER_GCC || \
...
#ifdef ABACUS_COMPILER_GCC34
#define ABACUS_NEW_TEMPLATE_SYNTAX
#endif

#ifdef ABACUS_COMPILER_GCC41
#define ABACUS_NEW_TEMPLATE_SYNTAX
#endif

#ifdef ABACUS_COMPILER_GCC33
#define ABACUS_NEW_TEMPLATE_SYNTAX
#endif


#ifdef ABACUS_COMPILER_SUN
#define ABACUS_NO_BOOL
#define ABACUS_NO_FOR_SCOPE
#define ABACUS_OLD_NEW
#endif


#ifdef ABACUS_NO_BOOL
  enum ABACUS_BOOL {false, true};
  typedef enum ABACUS_BOOL bool;
#endif
...
#define ABACUS_VERSION 300
#define ABACUS_VERSION_STRING "3.0.0"
