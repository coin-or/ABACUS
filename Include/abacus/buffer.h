 ...
 */
      ABA_BUFFER(const ABA_GLOBAL *glob, ABA_MESSAGE &msg);

/*! Packs the data of the buffer in an ABA_MESSAGE object.
 *
 * \param msg The ABA_MESSAGE object in which the buffer is packed.
 */
