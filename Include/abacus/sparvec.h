 ...
 */
      ABA_SPARVEC(const ABA_GLOBAL *glob, ABA_MESSAGE &msg);

/*! Packs the data of the sparse vector in an ABA_MESSAGE object.
 *
 *   \param msg The ABA_MESSAGE object in which the sparse vector
 *                  is packed.
 */
