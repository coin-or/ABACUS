 ...
 *
 *  \param msg The ABA_MESSAGE object from which the sense is initialized.
 */
      ABA_CSENSE(ABA_GLOBAL *glob, ABA_MESSAGE &msg);

/*! Packs the data of the sense in an ABA_MESSAGE object.
 *
 *  \param msg The ABA_MESSAGE object in which the sense is packed.
 */
