 ...
 *   creates the type from an ABA_MESSAGE.
 *
 *     \param msg The message from which the type is initialized.
 */
      ABA_VARTYPE(ABA_MESSAGE &msg);

/*! Packs the type in an ABA_MESSAGE.
 *
 *   \param msg The ABA_MESSAGE object in which the type is packed.
 */
