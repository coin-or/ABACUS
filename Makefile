...
CCFLAG_COMPILER = -DABACUS_COMPILER_GCC41 -Wall
CCFLAG_DEBOPT   = -O3
CCFLAG_PARALLEL =
...
tar:	subdirs $(ABACUS_HEADERS) $(ABACUS_ALL_CC)
	tar -czf abacus.tar.gz .abacus Make* ETI Include INSTALL README COPYRIGHT sources example
